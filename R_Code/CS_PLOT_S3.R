## LOADING DATA
Sheridan_mis <- readRDS("Sheridan_misspecified_sim4.rds")
Sheridan_cor <- readRDS("Sheridan_correct_sim4.rds")

p_value_mis <- readRDS("p_value_misspecified_sim4.rds")
p_value_cor <- readRDS("p_value_correct_sim4.rds")

NP_mis <- readRDS("NP_misspecified_sim4.rds")
NP_cor <- readRDS("NP_correct_sim4.rds")
...
## 导出
pdf("Combined_Simulation_4_two_panels.pdf", width = 14, height = 8)
print(p_all)
dev.off()
